...
const CategoryCard = ({
  ...
  return (
    <div className="group w-44 h-60  md:w-56 md:h-72 shrink-0 text-white font-heading rounded-tl-3xl cursor-pointer hover:drop-shadow-white active:drop-shadow-whiteMin flex flex-col rounded-lg justify-center items-center opacity-100  relative bg-black  overflow-hidden">
      <img
